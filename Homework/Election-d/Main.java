public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Ballotarr.length; i++) {
            ...
            String ID = Ballotarr[i].substring(0, 6);
    ...
    public static boolean Repeat(String ID) {

        int error_found = 0;

        for (int i = 0; i < Ballotarr.length; i++) {

            if (ID.equals(Ballotarr[i].substring(0, 6))) {
                error_found++;
            }

        }

        if (error_found > 1) return true;

        return false;

    }

    public static void votecounter(int president_vote, int vice_vote, int secretary_vote, int treasurer_vote){

        if (president_vote == 1) {
            p1++;
        } else if (president_vote == 2) {
            p2++;
        } else if (president_vote == 3) {
            p3++;
        } else if (president_vote == 4) {
            p4++;
        }
        ...
        if (secretary_vote == 1) {
            s1++;
        } else if (secretary_vote == 2) {
            s2++;
        } else if (secretary_vote == 3) {
            s3++;
        } else if (secretary_vote == 4) {
            s4++;
        }

        if (treasurer_vote == 1) {
            t1++;
        } else if (treasurer_vote == 2) {
            t2++;
        } else if (treasurer_vote == 3) {
            t3++;
        } else if (treasurer_vote == 4) {
            t4++;
        }
